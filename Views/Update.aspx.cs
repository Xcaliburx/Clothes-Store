    ...
    public partial class Update : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                cloth = ClothesRepository.getClothesbyId(id);

                TxtName.Text = cloth.Name;
                TxtDesc.Text = cloth.Description;
                TxtPrice.Text = cloth.Price.ToString();
                TxtType.Text = cloth.Type;
            }
        }
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (check)
            {
                Cloth newCloth = ClothFactory.createCloth(name, type, desc, price);
                ClothesRepository.updateClothes(cloth.ClothId, newCloth);
                msg += "Success Update";
            }
